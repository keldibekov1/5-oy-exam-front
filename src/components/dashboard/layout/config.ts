...
export const navItems = [
  ...
  { key: 'transactions', title: 'Transactions', href: paths.dashboard.transactions, icon: 'money' }, // 🔥 Yangi tranzaksiyalar
  ...
  { key: 'return', title: 'Returns', href: paths.dashboard.return, icon: 'undo' }, // 🔥 Yangi qaytarmalar
